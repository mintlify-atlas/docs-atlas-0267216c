...
| `contributor` | Read-only access to issues and events |
...
<ResponseField name="role" type="string">
  The member's role. One of `owner`, `manager`, `admin`, `member`, or `contributor`.
</ResponseField>
...
<ParamField body="role" type="string" required>
  The role to assign. One of `owner`, `manager`, `admin`, `member`, or `contributor`.
</ParamField>
